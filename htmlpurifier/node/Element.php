...
class NodeElement extends \HTMLPurifier\Node
{
    ...
    public function toTokenPair() {
        ...
        if ($this->empty) {
            return array(new TokenEmpty($this->name, $this->attr, $this->line, $this->col, $this->armor), null);
        } else {
            $start = new TokenStart($this->name, $this->attr, $this->line, $this->col, $this->armor);
            $end = new TokenEnd($this->name, array(), $this->endLine, $this->endCol, $this->endArmor);
            //$end->start = $start;
