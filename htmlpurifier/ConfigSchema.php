...
class ConfigSchema
{
    ...
    {
        $contents = file_get_contents(PREFIX . '/HTMLPurifier/ConfigSchema/schema.ser');
    ...
    {
        if ($prototype !== null) {
            ConfigSchema::$singleton = $prototype;
        } elseif (ConfigSchema::$singleton === null || $prototype === true) {
            ConfigSchema::$singleton = ConfigSchema::makeFromSerial();
        }
