...
class ConfigSchemaInterchangeBuilder
{
    ...
    {
        $this->varParser = $varParser ? $varParser : new VarParserNative();
    }
    ...
    {
        $builder = new ConfigSchemaInterchangeBuilder();
        $interchange = new ConfigSchemaInterchange();
    ...
    {
        if (!$dir) {
            $dir = PREFIX . '/HTMLPurifier/ConfigSchema/schema';
        }
    ...
    {
        $directive = new ConfigSchemaInterchangeDirective();
