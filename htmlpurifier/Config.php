...
class Config
{
    ...
    public function __construct($definition, $parent = null)
    {
        ...
        $this->parser = new VarParserFlexible();
    }
    ...
    public static function create($config, $schema = null)
    {
        ...
        if (!$schema) {
            $ret = Config::createDefault();
        } else {
            $ret = new Config($schema);
        }
        if (is_string($config)) {
            $ret->loadIni($config);
     ...
     */
    public static function inherit(Config $config)
    {
    ...
    {
        $ret = Config::prepareArrayFromForm($array, $index, $allowed, $mq_fix, $schema);
        $config = Config::create($ret, $schema);
        return $config;
    }
    ...
    {
         $ret = Config::prepareArrayFromForm($array, $index, $allowed, $mq_fix, $this->def);
         $this->loadArray($ret);
    }
    ...
    public static function prepareArrayFromForm($array, $index = false, $allowed = true, $mq_fix = true, $schema = null)
    {
        ...
        $allowed = Config::getAllowedDirectivesForForm($allowed, $schema);
        $ret = array();
