...
class StrategyFixNesting extends \HTMLPurifier\Strategy
{
    ...
    public function execute($tokens, $config, $context)
    {
        ...
        // refer to substrings
        $top_node = Arborize::arborize($tokens, $config, $context);
        ...
        while (!empty($stack)) {
            ...
            if ($excludes_enabled && isset($excludes[$node->name])) {
                $node->dead = true;
                if ($e) $e->send(E_ERROR, 'StrategyFixNesting: Node excluded');
            } else {
                ...
                if ($result === true) {
                    ...
                    $node->dead = true;
                    if ($e) $e->send(E_ERROR, 'StrategyFixNesting: Node removed');
                } else {
